...
**Currently focused on making software security more accessible through autonomous AI systems.**
...
### [Cortex](https://www.cortex-edr.com) &nbsp;·&nbsp; AI-Powered Application Security Scanner
...
`TypeScript` `FastAPI` `Claude Sonnet` `Next.js` `OSV.dev` &nbsp;·&nbsp; **Founder & Chief Engineer** &nbsp;·&nbsp; [npm](https://www.npmjs.com/package/@cortexedr/cli) &nbsp;·&nbsp; [github](https://github.com/Cortex-Edr) &nbsp;·&nbsp; [cortex-edr.com](https://www.cortex-edr.com)
...
```json
{ "eye_open": 0.7, "smile": 0.4, "blush": 0.1, "brow_angle": -0.3 }
```

`Python` `Rust` `TypeScript` `PixiJS` `ZeroMQ` &nbsp;·&nbsp; **Experimental R&D** &nbsp;·&nbsp; [live demo](https://anya-web-nu.vercel.app) &nbsp;·&nbsp; [opensource github repo](https://github.com/hamza-hafeez82/Anya)

---

## Flagship Research &nbsp;·&nbsp; [Project Cortex](https://github.com/hamza-hafeez82/Project-Cortex)
...
|---|---|---|
| Orchestrator | Dorsolateral PFC | executive coordination |
| Specialist agents | Cortical columns | reasoning · planning · risk · memory · execution |
| Shared working memory | Working memory buffer | structured turn-scoped context |
| Safety arbitration | ACC conflict monitoring | multi-layer conflict resolution |
| Transparent reasoning | PFC-to-subcortex pathways | interpretable, auditable decisions |
...
`Apache 2.0 + Responsible Use Policy` &nbsp;·&nbsp; [read the paper →](https://github.com/hamza-hafeez82/Project-Cortex)
...
```
languages      Go · Python · TypeScript · C++ · Dart · SQL
frontend       Next.js · React · Flutter · PixiJS · Tailwind
backend        FastAPI · WebSockets · ZeroMQ · REST
databases      PostgreSQL · Redis · Supabase
AI / ML        multi-agent · RAG · LLM orchestration · computer vision
robotics       sensor fusion · message bus · embodied cognition
devops         Docker · CI/CD · GitHub Actions · npm
security       static analysis · CVE triage · OSV.dev
```
...
*"building systems that think, feel, and ship best."*
